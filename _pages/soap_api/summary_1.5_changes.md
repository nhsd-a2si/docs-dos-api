...
*Note: These features are currently in development and will not be available for the first iteration of web service v1.5. They will, however, be released very soon after the release of DoS version 4.15 and should be factored into any development accordingly*
